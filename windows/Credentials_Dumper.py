...
if __name__ == '__main__':
    ...
    parser.add_argument('-b','--browser',type=str,metavar='',required=True,help='Browser Name:chrome/msedge/brave/opera')
    parser.add_argument('-c','--command',type=str,metavar='',required=True,help='Command to Excute:passwords/cookies/history/creditcards')
